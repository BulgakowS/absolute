...
$wpsf_ubermedia_settings[] = array(
    ...
    'fields' => array(
        array(
            ...
            'desc' => '',
            'type' => 'custom',
            'std' => 'Website: <a href="http://wordpress.org/extend/plugins/uber-media/" target="_blank">Media Manager Plus</a><br />
            Created by: <a href="http://dev7studios.com" target="_blank">Dev7studios</a><br />
            Support: <a href="http://support.dev7studios.com/discussions/uber-media-wordpress-plugin" target="_blank">Support Forums</a><br />
